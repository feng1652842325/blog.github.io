<template><div><p>在微信开发者工具中有时候会遇到ios和Android上不兼容的问题，因此这里做一个记录，方便排查问题</p>
<h3 id="时间转换问题" tabindex="-1"><a class="header-anchor" href="#时间转换问题" aria-hidden="true">#</a> 时间转换问题</h3>
<p>new  Date(&quot;时间&quot;) 在IOS会出现NAN的情况所以对于时间转换需要另行封装</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token function-variable function">formatDate</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token parameter">date</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="webview缓存问题" tabindex="-1"><a class="header-anchor" href="#webview缓存问题" aria-hidden="true">#</a> webview缓存问题</h3>
<p>在微信小程序中使用webview嵌套h5页面时 在某些安卓手机中会有缓存问题 导致页面无法及时更新 因此需要在跳转webview地址中携带版本号</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">let</span> config<span class="token punctuation">;</span>
