import{_ as n}from"./framework-c27b6911.js";import{o as s,c as a,a as t}from"./app-5d92d645.js";const e={},p=t(`<p>防抖和节流可谓是老生常谈了，其目的都是为了防止高频率的js代码的执行</p><div class="hint-container tip"><p class="hint-container-title">防抖</p><p>当一个函数连续触发，只执行最后一次。</p></div><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// fn是你要调用的函数，delay是防抖的时间</span>
